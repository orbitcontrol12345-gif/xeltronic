...
const isActive = (href: string) => {
  ...
  return (
    <header className="fixed left-0 top-0 z-50 h-20 md:h-45 w-full border-b border-white/10 bg-[#071018]/75 backdrop-blur-xl">
      <div className="mx-auto flex h-full max-w-7xl items-center justify-between px-4 py-1 md:px-6 md:py-4 lg:translate-y-2">
    ...
    🔍
        ...
        <a href="/" className="flex items-center gap-3">
          <img
            src="/logo.png.png"
            alt="Xeltronic"
            className="max-h-54 md:max-h-55 w-auto object-contain"
          />
        </a>
